...
pd.pivot_table(data = ecis, index = "province", columns = "level_1", values = "eci").reset_index().sort_values(by = 0.50, ascending = False).to_csv("fig_9.csv", sep = "\t", index = False, header = False)
