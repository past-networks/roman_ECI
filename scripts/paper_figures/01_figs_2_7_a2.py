...
dfs = rdata.read_rds("../../results/economic_complexity/province_all_bias_tbs{hisco_tag}.rds")
...
mcp.to_csv("fig_a2_bottom{hisco_tag}.csv", sep = "\t", index = False, header = False)

# Only Latin provinces, no language correction
dfs = rdata.read_rds("../../results/economic_complexity/filtered_province_all_but_language_bias_tbs{hisco_tag}.rds")
...
mcp.to_csv("fig_2.csv", sep = "\t", index = False, header = False)
...
mcp.to_csv("fig_a2_top.csv", sep = "\t", index = False, header = False)
...
mcp.to_csv("fig_7.csv", sep = "\t", index = False, header = False)
