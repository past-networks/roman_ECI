---
title: "Occupations in Greek inscriptions - evaluation of NLP methods"
author: 
...
occups <- read_tsv("Occupations_GREEK.tsv")
...
# exploring one inscription where the occupational term occurs, lemmata
...
# preparing data for manual / human evaluation
...
### Findings of human evaluation (close reading):
...
`4655 inscriptions with at least one occupation`
`5424 occurrences of occupation`
`158 unique occupations`

- but there is no guarantee they are correctly assigned. We assume that half of them might be incorrect.
...
### Control for known problematic lemmata manually

`Inhabitant of Halai deme Ἁλαιεὺς vs fisherman ἁλιεύς`
...
#### Fixing attempt 2
Morphological dictionary - Old approach using the full declension from   https://en.wiktionary.org/wiki/%E1%BC%81%CE%BB%CE%B9%CE%B5%CF%8D%CF%82
